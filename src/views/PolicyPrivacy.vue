<template>
    ...
    <main class="holder">
        <!-- Start Hero -->
        <section class="relative table w-full py-32 lg:py-40 dark:bg-gray-800 bg-[url('@/assets/bg01.jpg')] bg-no-repeat bg-center rounded-b-3xl">
            <div class="absolute inset-0 bg-black opacity-80 -z-4  rounded-b-3xl"></div>
            <div class="container">
                <div class="grid grid-cols-1 text-center mt-10 ">
                    <h3 class="text-6xl leading-normal font-semibold text-gray-100 z-10">Policy And Privacy</h3>
                </div><!--end grid-->
            </div><!--end container-->
                    ...
                    <div class="md:w-3/4">
                        <div class="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-md">
                            ...
                            <ul class="list-none text-slate-400 mt-3">
                                <li class="flex mt-2"><i class="uil uil-arrow-right text-indigo-600 text-lg align-middle ltr:mr-2 rtl:ml-2"></i>Digital Marketing Solutions for Tomorrow</li>
                                <li class="flex mt-2"><i class="uil uil-arrow-right text-indigo-600 text-lg align-middle ltr:mr-2 rtl:ml-2"></i>Our Talented & Experienced Marketing Agency</li>
                                <li class="flex mt-2"><i class="uil uil-arrow-right text-indigo-600 text-lg align-middle ltr:mr-2 rtl:ml-2"></i>Create your own skin to match your brand</li>
                                <li class="flex mt-2"><i class="uil uil-arrow-right text-indigo-600 text-lg align-middle ltr:mr-2 rtl:ml-2"></i>Digital Marketing Solutions for Tomorrow</li>
                                <li class="flex mt-2"><i class="uil uil-arrow-right text-indigo-600 text-lg align-middle ltr:mr-2 rtl:ml-2"></i>Our Talented & Experienced Marketing Agency</li>
                                <li class="flex mt-2"><i class="uil uil-arrow-right text-indigo-600 text-lg align-middle ltr:mr-2 rtl:ml-2"></i>Create your own skin to match your brand</li>
                            </ul>
                            ...
                            <div id="accordion-collapse" data-accordion="collapse" class="mt-6">
                                ...
                                <div class="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden mt-4">
                                    <h2 class="text-base font-semibold" id="accordion-collapse-heading-4">
                                        <button type="button" class="flex justify-between items-center p-5 w-full font-medium ltr:text-left rtl:text-right" data-accordion-target="#accordion-collapse-body-4" aria-expanded="false" aria-controls="accordion-collapse-body-4">
                            ...
                            <div class="mt-6 space-x-2">
                                <a href="" class="p-5 bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-white rounded-md">Accept</a>
                                <a href="" class="p-5 bg-transparent hover:bg-red-600 border-red-600 text-red-600 hover:text-white rounded-md ltr:ml-2 rtl:mr-2">Decline</a>
                            </div>
                        </div>
                    </div><!--end -->
                </div><!--end grid-->
