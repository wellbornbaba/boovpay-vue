<template>
    <header class="mx-auto flex items-center justify-between p-4">
        <!-- Start Navbar -->
        <nav id="topnav" class="leading-[4.4rem] is-sticky fixed right-0 left-0 top-0 border-0 bg-transparent transition-all">
            <div class="container">
                <!-- Logo container-->
                <a class="logo ltr:pl-0 rtl:pr-0" href="index.html">
                ...
                <ul class="buy-button list-none mb-0">
                    ...
                    <li class="inline ltr:pl-1 rtl:pr-1 mb-0">
                ...
                <div id="navigation">
                    ...
                    <ul class="m-0 list-none p-0">
                        <li class="relative mt-0 mr-2 block"><a href="index.html" class=" bg-transparent block font-bold text-xs leading-6 px-4 text-black uppercase tracking-wider hover:text-bvprimary active:text-bvprimary dark:text-white sub-menu-item">Home</a></li>

                        <li class="relative mt-0 mr-2 block parent-parent-menu-item">
                            <a href="javascript:void(0)" class="bg-transparent block font-bold text-xs leading-6 px-4 text-black uppercase tracking-wider hover:text-bvprimary active:text-bvprimary dark:text-white">Landing</a><span class="menu-arrow"></span>
                            ...
                            <ul class="submenu megamenu">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="index-saas.html" class="sub-menu-item">Saas
                                                <span
                                                    class="bg-emerald-600 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ltr:ml-1 rtl:mr-1">Animation</span></a>
                                        </li>
                                        <li>
                                            <a href="index-classic-saas.html" class="sub-menu-item">Classic Saas
                                            </a>
                                        </li>
                                        <li>
                                            <a href="index-modern-saas.html" class="sub-menu-item">Modern Saas
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="index-classic-app.html" class="sub-menu-item">Classic App
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="index-seo.html" class="sub-menu-item">SEO Agency </a>
                                        </li>
                                        <li>
                                            <a href="index-payment.html" class="sub-menu-item">Payments
                                                <span
                                                    class="bg-orange-600 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ltr:ml-1 rtl:mr-1">New</span></a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="index-it-solution-two.html" class="sub-menu-item">It Solution Two
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="index-gym.html" class="sub-menu-item">Gym
                                                <span
                                                    class="bg-black dark:bg-slate-50 inline-block text-white dark:text-slate-900 text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ltr:ml-1 rtl:mr-1">Dark</span></a>
                                        </li>
                                        <li>
                                            <a href="index-nft.html" class="sub-menu-item">NFT Marketplace </a>
                                        </li>
                                        <li>
                                            <a href="index-hotel.html" class="sub-menu-item">Hotel & Resort
                                                <span
                                                    class="bg-orange-600 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ltr:ml-1 rtl:mr-1">New</span></a>
                                        </li>
                                    </ul>
                                ...
                                <li>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="index-corporate-two.html" class="sub-menu-item">Corporate Two
                                            </a>
                                        </li>
                                        <li>
                                            <a href="index-real-estate.html" class="sub-menu-item">Real Estate</a>
                                        </li>
                                        <li>
                                            <a href="index-consulting.html" class="sub-menu-item">Consulting
                                            </a>
                                        </li>
                                        <li>
                                            <a href="index-insurance.html" class="sub-menu-item">Insurance </a>
                                        </li>
                                        <li>
                                            <a href="index-construction.html" class="sub-menu-item">Construction
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="index-photography.html" class="sub-menu-item">Photography
                                                <span
                                                    class="bg-black dark:bg-slate-50 inline-block text-white dark:text-slate-900 text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ltr:ml-1 rtl:mr-1">Dark</span></a>
                                        </li>
                                        <li><a href="index-studio.html" class="sub-menu-item">Studio</a></li>
                                        <li>
                                            <a href="index-coworking.html" class="sub-menu-item">Co-Woriking</a>
                                        </li>
                                        <li>
                                            <a href="index-course.html" class="sub-menu-item">Online Courses
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="index-event.html" class="sub-menu-item">Event/Conference
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="index-service.html" class="sub-menu-item">Service Provider</a>
                                        </li>
                                        <li>
                                            <a href="index-food-blog.html" class="sub-menu-item">Food Blog </a>
                                        </li>
                        ...
                        <li class="relative mt-0 mr-2 block parent-parent-menu-item">
                            <a href="javascript:void(0)" class="bg-transparent block font-bold text-xs leading-6 px-4 text-black uppercase tracking-wider hover:text-bvprimary active:text-bvprimary dark:text-white">Pages</a><span class="menu-arrow"></span>
                            <ul class="submenu">
                                <li class="relative parent-menu-item">
                                    <a href="javascript:void(0)"> Company </a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                                        <li>
                                            <a href="page-aboutus.html" class="sub-menu-item"> About Us</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="page-testimonial.html" class="sub-menu-item">Testimonial
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="relative parent-menu-item">
                                    <a href="javascript:void(0)"> Accounts</a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                                        <li>
                                ...
                                <li class="relative parent-menu-item">
                                    <a href="javascript:void(0)"> Real Estate</a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                                        <li>
                                ...
                                <li class="relative parent-menu-item">
                                    <a href="javascript:void(0)"> Courses </a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                                        <li>
                                            <a href="course-listing.html" class="sub-menu-item">Course Listing</a>
                                        </li>
                                        <li>
                                            <a href="course-detail.html" class="sub-menu-item">Course Detail</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="relative parent-menu-item">
                                    <a href="javascript:void(0)"> NFT Market </a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                                        <li><a href="nft-explore.html" class="sub-menu-item">Explore</a></li>
                                        <li><a href="nft-auction.html" class="sub-menu-item">Auction</a></li>
                                        <li>
                                            <a href="nft-collection.html" class="sub-menu-item">Collections</a>
                                        </li>
                                        <li>
                                            <a href="nft-creators.html" class="sub-menu-item">Creators</a>
                                        </li>
                                        <li><a href="nft-wallet.html" class="sub-menu-item">Wallet</a></li>
                                        <li>
                                            <a href="nft-create-item.html" class="sub-menu-item">Create NFT</a>
                                        </li>
                                        <li>
                                            <a href="nft-detail.html" class="sub-menu-item">Single NFT</a>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="food-recipe.html" class="sub-menu-item">Food Recipe </a></li>
                                <li class="relative parent-menu-item">
                                    <a href="javascript:void(0)"> Photography </a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                                        <li>
                                            <a href="photography-about.html" class="sub-menu-item">About Us</a>
                                        </li>
                                        <li>
                                            <a href="photography-portfolio.html" class="sub-menu-item">Portfolio</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="relative parent-menu-item">
                                ...
                                <li class="relative parent-menu-item">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li class="relative child-menu-item">
                                            <a href="javascript:void(0)"> Blog Posts </a><span
                                                class="submenu-arrow"></span>
                                            <ul class="submenu">
                                                <li>
                                                    <a href="blog-standard-post.html" class="sub-menu-item">Standard
                                                        Post</a>
                                                </li>
                                                <li>
                                                    <a href="blog-slider-post.html" class="sub-menu-item">Slider
                                                        Post</a>
                                                </li>
                                                <li>
                                                    <a href="blog-gallery-post.html" class="sub-menu-item">Gallery
                                                        Post</a>
                                                </li>
                                                <li>
                                                    <a href="blog-youtube-post.html" class="sub-menu-item">Youtube
                                                        Post</a>
                                                </li>
                                                <li>
                                                    <a href="blog-vimeo-post.html" class="sub-menu-item">Vimeo Post</a>
                                                </li>
                                                <li>
                                                    <a href="blog-audio-post.html" class="sub-menu-item">Audio Post</a>
                                                </li>
                                                <li>
                                                    <a href="blog-blockquote-post.html"
                                                        class="sub-menu-item">Blockquote</a>
                                                </li>
                                                <li>
                                                    <a href="blog-left-sidebar-post.html" class="sub-menu-item">Left
                                                        Sidebar</a>
                                                </li>
                                            </ul>
                                        </li>
                                ...
                                <li class="relative parent-menu-item">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li>
                                            <a href="auth-lock-screen.html" class="sub-menu-item">Lock Screen</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="relative parent-menu-item">
                                ...
                                <li class="relative parent-menu-item">
                                    <a href="javascript:void(0)"> Multi Level Menu</a><span
                                        class="submenu-arrow"></span>
                                    <ul class="submenu">
                                        <li>
                        ...
                        <li class="relative mt-0 mr-2 block parent-parent-menu-item">
                            <a href="javascript:void(0)" class="bg-transparent block font-bold text-xs leading-6 px-4 text-black uppercase tracking-wider hover:text-bvprimary active:text-bvprimary dark:text-white">Portfolio</a><span class="menu-arrow"></span>
                            <ul class="submenu megamenu">
                                <li>
                                    <ul>
                                        <li class="font-bold text-xs leading-4 pt-2 pr-5 text-black uppercase tracking-wider whitespace-no-wrap">Modern Portfolio</li>
                                        <li>
                                ...
                                <li>
                                    <ul>
                                        <li class="font-bold text-xs leading-4 pt-2 pr-5 text-black uppercase tracking-wider whitespace-no-wrap">Classic Portfolio</li>
                                        <li>
                                            <a href="portfolio-classic-two.html" class="sub-menu-item">Two Column</a>
                                        </li>
                                        <li>
                                            <a href="portfolio-classic-three.html" class="sub-menu-item">Three
                                                Column</a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    <ul>
                                        <li class="font-bold text-xs leading-4 pt-2 pr-5 text-black uppercase tracking-wider whitespace-no-wrap">Creative Portfolio</li>
                                        <li>
                                            <a href="portfolio-creative-two.html" class="sub-menu-item">Two Column</a>
                                        </li>
                                        <li>
                                            <a href="portfolio-creative-three.html" class="sub-menu-item">Three
                                                Column</a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    <ul>
                                        <li class="font-bold text-xs leading-4 pt-2 pr-5 text-black uppercase tracking-wider whitespace-no-wrap">Masonry Portfolio</li>
                                        <li>
                                            <a href="portfolio-masonry-two.html" class="sub-menu-item">Two Column</a>
                                        </li>
                                        <li>
                                            <a href="portfolio-masonry-three.html" class="sub-menu-item">Three
                                                Column</a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    <ul>
                                        <li class="font-bold text-xs leading-4 pt-2 pr-5 text-black uppercase tracking-wider whitespace-no-wrap">Portfolio Detail</li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="portfolio-detail-four.html" class="sub-menu-item">Portfolio
                                                Four</a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <li class="relative mt-0 mr-2 block parent-menu-item">
                            <a href="javascript:void(0)" class="bg-transparent block font-bold text-xs leading-6 px-4 text-black uppercase tracking-wider hover:text-bvprimary active:text-bvprimary dark:text-white">Docs</a><span class="menu-arrow"></span>
                            <ul class="submenu">
                                <li>
                        ...
                        <li class="relative mt-0 mr-2 block">
                            <a href="contact-one.html" class="bg-transparent block font-bold text-xs leading-6 px-4 text-black uppercase tracking-wider hover:text-bvprimary active:text-bvprimary dark:text-white sub-menu-item">Contact</a></li>
                    </ul>
                    <!--end navigation menu-->
                </div>
                <!--end navigation-->
